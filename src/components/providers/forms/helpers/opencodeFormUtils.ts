...
import {
  ERGOUZI_ANTHROPIC_BASE_URL,
  ERGOUZI_CODEX_CONFIG,
  ERGOUZI_GEMINI_BASE_URL,
  ERGOUZI_OPENAI_BASE_URL,
} from "@/config/ergouziDefaults";
...
export const CODEX_DEFAULT_CONFIG = JSON.stringify(
  { auth: { OPENAI_API_KEY: "" }, config: ERGOUZI_CODEX_CONFIG },
  null,
  2,
);
...
export const OPENCODE_DEFAULT_CONFIG = JSON.stringify(
  {
    ...
    options: {
      baseURL: ERGOUZI_OPENAI_BASE_URL,
      apiKey: "",
      setCacheKey: true,
    },
    models: {},
