...
- **ArchLinux 安装支持** (#259)
  添加 AUR 安装方式：`paru -S ergouzi-switch-bin`
...
访问 [Releases](https://github.com/suboxiu88-coder/ergouzi-switch/releases/latest) 下载最新版本
...
- **深度链接集成** - 通过 `ergouziswitch://` 协议导入配置
- **系统托盘** - 从托盘菜单快速切换
...
v3.7.0 代表了 Ergouzi Switch 定位的转变：
...
访问 [Releases](https://github.com/suboxiu88-coder/ergouzi-switch/releases/latest) 下载：

- **Windows**：`Ergouzi-Switch-Windows.msi` 或 `-Portable.zip`
- **macOS**：`Ergouzi-Switch-macOS.tar.gz` 或 `.zip`
- **Linux**：`Ergouzi-Switch-Linux.AppImage` 或 `.deb`
...
[使用 "ergouzi-switch" 优惠码注册享 9 折优惠](https://www.packyapi.com/register?aff=ergouzi-switch)
...
- **问题反馈**：[GitHub Issues](https://github.com/suboxiu88-coder/ergouzi-switch/issues)
- **讨论**：[GitHub Discussions](https://github.com/suboxiu88-coder/ergouzi-switch/discussions)
