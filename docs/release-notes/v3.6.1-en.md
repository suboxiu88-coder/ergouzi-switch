# Ergouzi Switch v3.6.1

> Stability improvements and user experience optimization (based on v3.6.0)

**[中文更新说明 Chinese Documentation →](https://github.com/suboxiu88-coder/ergouzi-switch/blob/main/docs/release-notes/v3.6.1-zh.md)**
...
- Download `Ergouzi-Switch-v3.6.1-macOS.zip` from [Assets](#assets) below
...
- **Installer**: `Ergouzi-Switch-v3.6.1-Windows.msi`
- **Portable**: `Ergouzi-Switch-v3.6.1-Windows-Portable.zip`

#### Linux

- **AppImage**: `Ergouzi-Switch-v3.6.1-Linux.AppImage`
- **Debian**: `Ergouzi-Switch-v3.6.1-Linux.deb`

---

### 📚 Documentation

- [中文文档 (Chinese)](https://github.com/suboxiu88-coder/ergouzi-switch/blob/main/README_ZH.md)
- [English Documentation](https://github.com/suboxiu88-coder/ergouzi-switch/blob/main/README.md)
- [完整更新日志 (Full Changelog)](https://github.com/suboxiu88-coder/ergouzi-switch/blob/main/CHANGELOG.md)
...
**Full Changelog**: https://github.com/suboxiu88-coder/ergouzi-switch/compare/v3.6.0...v3.6.1
...
- **Customizable Storage Location** - Customize Ergouzi Switch's configuration storage directory
...
## 🌟 About Ergouzi Switch

Ergouzi Switch is a cross-platform desktop application for managing and switching between different provider configurations for Claude Code and Codex. Built with Tauri 2.0 + React 18 + TypeScript, supporting Windows, macOS, and Linux.
...
**Project Repository**: https://github.com/suboxiu88-coder/ergouzi-switch
