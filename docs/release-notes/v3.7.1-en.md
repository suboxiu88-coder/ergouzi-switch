...
- **ArchLinux Installation Support** (#259)
  Added AUR installation method: `paru -S ergouzi-switch-bin`
...
Visit [Releases](https://github.com/suboxiu88-coder/ergouzi-switch/releases/latest) to download the latest version
...
- **Deep link integration** - Import via `ergouziswitch://` protocol
...
v3.7.0 represents a shift in Ergouzi Switch's positioning:
...
Visit [Releases](https://github.com/suboxiu88-coder/ergouzi-switch/releases/latest) to download:

- **Windows**: `Ergouzi-Switch-Windows.msi` or `-Portable.zip`
- **macOS**: `Ergouzi-Switch-macOS.tar.gz` or `.zip`
- **Linux**: `Ergouzi-Switch-Linux.AppImage` or `.deb`
- **ArchLinux**: `paru -S ergouzi-switch-bin`
...
[Register with "ergouzi-switch" code for 10% discount](https://www.packyapi.com/register?aff=ergouzi-switch)
...
- **Issues**: [GitHub Issues](https://github.com/suboxiu88-coder/ergouzi-switch/issues)
- **Discussions**: [GitHub Discussions](https://github.com/suboxiu88-coder/ergouzi-switch/discussions)
