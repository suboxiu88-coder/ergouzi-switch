...
**[中文更新说明 Chinese Documentation →](https://github.com/suboxiu88-coder/ergouzi-switch/blob/main/docs/release-notes/v3.6.0-zh.md)**
...
- Download `Ergouzi-Switch-v3.6.0-macOS.zip` from [Assets](#assets) below
...
- **Installer**: `Ergouzi-Switch-v3.6.0-Windows.msi`
- **Portable**: `Ergouzi-Switch-v3.6.0-Windows-Portable.zip`

### Linux

- **AppImage**: `Ergouzi-Switch-v3.6.0-Linux.AppImage`
- **Debian**: `Ergouzi-Switch-v3.6.0-Linux.deb`
...
**Full Changelog**: https://github.com/suboxiu88-coder/ergouzi-switch/compare/v3.5.1...v3.6.0
