...
| File                                     | Description                                          |
| ---------------------------------------- | ---------------------------------------------------- |
| `Ergouzi-Switch-v3.11.0-Windows.msi`          | **Recommended** - MSI installer with auto-update     |
| `Ergouzi-Switch-v3.11.0-Windows-Portable.zip` | Portable version, extract and run, no registry write |

### macOS

| File                             | Description                                                          |
| -------------------------------- | -------------------------------------------------------------------- |
| `Ergouzi-Switch-v3.11.0-macOS.zip`    | **Recommended** - Extract and drag to Applications, Universal Binary |
| `Ergouzi-Switch-v3.11.0-macOS.tar.gz` | For Homebrew installation and auto-update                            |
