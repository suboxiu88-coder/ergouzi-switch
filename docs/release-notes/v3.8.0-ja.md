...
Ergouzi Switch v3.8.0 はデータ永続化レイヤーと UI を大幅に作り替え、今後のクラウド同期やローカルプロキシ機能に向けた基盤を整えたメジャーアップデートです。
...
[Releases](https://github.com/suboxiu88-coder/ergouzi-switch/releases/latest) から入手:

- **Windows**: `Ergouzi-Switch-v3.8.0-Windows.msi` または `-Portable.zip`
- **macOS**: `Ergouzi-Switch-v3.8.0-macOS.tar.gz` または `.zip`
- **Linux**: `Ergouzi-Switch-v3.8.0-Linux.AppImage` または `.deb`
...
[登録時に「ergouzi-switch」で 10% オフ](https://www.packyapi.com/register?aff=ergouzi-switch)
...
- **Issue**: [GitHub Issues](https://github.com/suboxiu88-coder/ergouzi-switch/issues)
