...
Ergouzi Switch provides rich icon customization features:
...
This ensures Ergouzi Switch and CLI tool configurations stay in sync.
...
When adding a provider, Ergouzi Switch automatically extracts endpoint URLs from the configuration.
