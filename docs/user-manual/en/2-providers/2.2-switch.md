...
2. Ergouzi Switch updates the configuration file
...
1. Right-click the Ergouzi Switch icon in the system tray
...
When switching providers, Ergouzi Switch modifies the following files:
