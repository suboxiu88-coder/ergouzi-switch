...
## What is Ergouzi Switch

Ergouzi Switch is a cross-platform desktop application designed for developers who use AI coding tools. It helps you centrally manage configurations for **Claude Code**, **Claude Desktop**, **Codex**, **Gemini CLI**, **OpenCode**, **OpenClaw**, and **Hermes**.
...
Ergouzi Switch solves these problems through a unified interface.
...
Ergouzi Switch is built with a modern technology stack:
