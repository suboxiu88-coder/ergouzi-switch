...
sequenceDiagram
    ...
    participant Proxy as Local Proxy (Ergouzi Switch)
...
After starting the proxy and enabling app takeover, Ergouzi Switch modifies app configurations:
...
When stopping the proxy, Ergouzi Switch will:
