...
Ergouzi Switch supports the `ccswitch://` deep link protocol, enabling one-click configuration import via links.
...
Ergouzi Switch automatically registers the `ccswitch://` protocol during installation.
