...
When enabling an app's toggle, Ergouzi Switch will:
...
When disabling an app's toggle, Ergouzi Switch will:
...
If you have already configured MCP servers in CLI tools, you can import them into Ergouzi Switch:

1. Click the "Import" button
2. Select the app to import from (Claude/Codex/Gemini/OpenCode)
3. Ergouzi Switch reads the existing configuration and imports it
