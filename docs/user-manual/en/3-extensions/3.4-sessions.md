...
**On macOS:**
- Ergouzi Switch launches your preferred terminal with the resume command
...
3. Ergouzi Switch launches the Claude terminal session in the selected directory
