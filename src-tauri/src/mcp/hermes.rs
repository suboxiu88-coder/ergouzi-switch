...
//!
//! Handles conversion between Ergouzi Switch unified MCP format and Hermes config.yaml format.
//!
//! ## Format mapping
//!
//! | Ergouzi Switch unified (JSON)                        | Hermes config.yaml (YAML)       |
//! |-------------------------------------------------|---------------------------------|
...
/// Ergouzi Switch has no OAuth UI, but losing the field on round-trip downgrades
...
// ============================================================================
// Format Conversion: Ergouzi Switch -> Hermes
// ============================================================================

/// Convert Ergouzi Switch unified format to Hermes format
///
/// Conversion rules:
...
// ============================================================================
// Format Conversion: Hermes -> Ergouzi Switch
// ============================================================================

/// Convert Hermes format to Ergouzi Switch unified format
///
/// Conversion rules:
...
/// `existing` — this prevents Ergouzi Switch from overwriting user customizations.
...
mod tests {
    ...
    fn test_merge_preserves_auth_field() {
        ...
        assert_eq!(
            merged["auth"], "oauth",
            "auth declaration must survive Ergouzi Switch round-trip"
        );
    }
