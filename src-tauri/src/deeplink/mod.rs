//! Deep link import functionality for Ergouzi Switch
//!
//! This module implements the ergouziswitch:// protocol for importing configurations
...
///
/// Represents a parsed ergouziswitch:// URL ready for processing.
