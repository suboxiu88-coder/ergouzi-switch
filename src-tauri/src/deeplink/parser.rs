...
//!
//! Parses ergouziswitch:// URLs into DeepLinkImportRequest structures.
...
/// Parse a ergouziswitch:// URL into a DeepLinkImportRequest
///
/// Expected format:
/// ergouziswitch://v1/import?resource={type}&...
pub fn parse_deeplink_url(url_str: &str) -> Result<DeepLinkImportRequest, AppError> {
    ...
    if scheme != "ergouziswitch" {
        return Err(AppError::InvalidInput(format!(
            "Invalid scheme: expected 'ergouziswitch', got '{scheme}'"
        )));
    }
